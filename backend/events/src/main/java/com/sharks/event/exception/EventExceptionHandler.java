package com.sharks.event.exception;
...
public class EventExceptionHandler {
	...
	ResponseEntity<ProblemDetail> handleNotFound(EventNotFoundException ex) {
	...
	ResponseEntity<ProblemDetail> handleDuplicate(DuplicateKeyException ex) {
		ProblemDetail detail = ProblemDetail.forStatusAndDetail(
				HttpStatus.CONFLICT, "An event with this name already exists");
